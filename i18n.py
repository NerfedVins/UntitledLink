...
STRINGS = {
    "en": {
        ...
        "filters": "filters",
        "went_wrong": "something went wrong :: {err}",
        "nothing_to_filter": "scan something first",
        "sec_kind": "kind", "sec_format": "format",
        "filters_hint": "Nothing ticked shows everything - tick what you want to see.",
    ...
    "el": {
        ...
        "filters": "φίλτρα",
        "went_wrong": "κάτι πήγε στραβά :: {err}",
        "nothing_to_filter": "σάρωσε κάτι πρώτα",
        "sec_kind": "είδος", "sec_format": "μορφή",
        "filters_hint": "Τίποτα τσεκαρισμένο σημαίνει όλα - τσέκαρε αυτό που θες να βλέπεις.",
        "sec_download": "λήψη",
